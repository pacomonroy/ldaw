	        ...
	        <div class="col-md-4 col-md-offset-4">
	            <div class="login-panel panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title">Login CodeIgniter</h3>
	                </div>
	                <div class="panel-body">
	                	<small id="login-empty-input" class="error">Email y password no pueden estar vacios <br>&nbsp;</small>
	                	<?php if($alert): ?>
	                		<small id="login-invalid-input" class="error">Password inválido<br>&nbsp;</small>
	                	<?php endif; ?>
